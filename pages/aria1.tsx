    ...
    <div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 pt-16 mx-auto">
          ...
          <button
            className="flex mx-auto mt-16 text-white bg-red-500 border-0 py-2 px-6 hover:bg-red-600 outline-none focus:ring-4 focus:ring-red-400 focus:ring-offset-2 rounded text-lg font-medium"
            id="dialog-trigger"
            onClick={handleDialogOpen}
          >
            Otwórz nieprzystosowany modal
          </button>
        </div>
      </section>
      ...
      >
        ...
        <div
          ...
          id="dialog"
        >
          <h2 className="text-xl font-bold">Modal testowy</h2>
